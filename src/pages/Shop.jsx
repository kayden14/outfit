              ...
              <div className="flex flex-col">
                ...
                <FAQAccordionItem title="How does the WhatsApp order system work?">
                  <p className="text-xs md:text-sm opacity-80 leading-relaxed">
                    We use a WhatsApp-integrated ordering system. Browse our catalog, click "Order Now" or select your size in the details modal, and click "Order via WhatsApp". This generates a custom message with your selected item details directly to our customer representative at 0201226473.
                  </p>
                </FAQAccordionItem>
