...
export const products = [
  // ── TEMEO SHIRTS ─────────────────────────────────────────
  {
    ...
    sizes: ["S", "M", "L", "XL", "XXL"],
    details: ["100% Heavyweight Cotton", "Art-grade front print", "Regular fit", "Pre-shrunk"],
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    details: ["100% Heavyweight Cotton", "Full-chest art print", "Oversized fit", "Limited run"],
    slug: "temeo-kaws-boss",
  },
  {
    id: "temeo-kaws-neon-bear",
    name: "TEMEO KAWS — Neon Bear",
    price: 80,
    category: "TEMEO Shirts",
    image: img125,
    backImage: img032,
    ...
    sizes: ["S", "M", "L", "XL"],
    details: ["100% Heavyweight Cotton", "Front art print", "Regular fit", "Themmie signature"],
    slug: "temeo-kaws-neon-bear",
  },
  {
    id: "temeo-kaws-squad",
    name: "TEMEO KAWS — Squad",
    price: 80,
    category: "TEMEO Shirts",
    image: img165,
    backImage: img258,
    ...
    sizes: ["XS", "S", "M", "L", "XL"],
    details: ["100% Heavyweight Cotton", "Photographic art print", "Regular fit"],
  ...
  },
  {
    ...
    sizes: ["S", "M", "L", "XL", "XXL"],
    details: ["100% Heavyweight Cotton", "Art-grade front print", "Classic fit"],
    slug: "temeo-mickey",
  },
  {
    id: "temeo-kaws-white",
    ...
    sizes: ["XS", "S", "M", "L", "XL"],
    details: ["100% Combed Cotton", "White colourway", "Art print front", "Relaxed fit"],
  ...
  // ── TEMEO WEARS ──────────────────────────────────────────
  {
    ...
    sizes: ["S", "M", "L", "XL"],
    details: ["Heavyweight 260gsm", "Oversized fit", "Premium cream fabric", "Back editorial print"],
  ...
  },
  {
    ...
    details: ["100% Combed Cotton", "Back print", "Classic fit", "Unisex"],
  ...
  },
  {
    ...
    sizes: ["XS", "S", "M", "L", "XL"],
    details: ["100% Cotton", "Art-inspired back print", "Classic fit"],
